...
NaSub <- function(x, repl = NA_real_, last_obs = TRUE, maxgap = -1L, leading = FALSE) {
    .Call('RollingWindow_NaSub', PACKAGE = 'RollingWindow', x, repl, last_obs, maxgap, leading)
}
...
RollingBeta <- function(x, y, window, expanding = FALSE, na_method = "none", pop = FALSE) {
    .Call('RollingWindow_RollingBeta', PACKAGE = 'RollingWindow', x, y, window, expanding, na_method, pop)
}
...
#'may be used.
RollingCompound <- function(x, window, scale = 1.0, expanding = FALSE, na_method = "none") {
    .Call('RollingWindow_RollingCompound', PACKAGE = 'RollingWindow', x, window, scale, expanding, na_method)
}
...
RollingCov <- function(x, y, window, expanding = FALSE, na_method = "none", pop = FALSE) {
    .Call('RollingWindow_RollingCov', PACKAGE = 'RollingWindow', x, y, window, expanding, na_method, pop)
}
...
RollingCorr <- function(x, y, window, expanding = FALSE, na_method = "none", pop = FALSE) {
    .Call('RollingWindow_RollingCorr', PACKAGE = 'RollingWindow', x, y, window, expanding, na_method, pop)
}
...
RollingKurt <- function(x, window, expanding = FALSE, na_method = "none", pop = FALSE) {
    .Call('RollingWindow_RollingKurt', PACKAGE = 'RollingWindow', x, window, expanding, na_method, pop)
}
...
#'@param na_method One of "none" (default), "ignore" or "window" (see notes on NA handling)
#'@return A matrix; rows 1 to (length(window) - 1) contain NAs.
RollingMax <- function(x, window, expanding = FALSE, na_method = "none") {
    .Call('RollingWindow_RollingMax', PACKAGE = 'RollingWindow', x, window, expanding, na_method)
}
...
RollingMean <- function(x, window, expanding = FALSE, na_method = "none") {
    .Call('RollingWindow_RollingMean', PACKAGE = 'RollingWindow', x, window, expanding, na_method)
}
...
RollingMAE <- function(x, y, window, expanding = FALSE, na_method = "none") {
    .Call('RollingWindow_RollingMAE', PACKAGE = 'RollingWindow', x, y, window, expanding, na_method)
}
...
RollingMS <- function(x, window, expanding = FALSE, na_method = "none") {
    .Call('RollingWindow_RollingMS', PACKAGE = 'RollingWindow', x, window, expanding, na_method)
}
...
#'where \eqn{x} and \eqn{y} represent the predicted and actual (true) values.
RollingMSE <- function(x, y, window, expanding = FALSE, na_method = "none") {
    .Call('RollingWindow_RollingMSE', PACKAGE = 'RollingWindow', x, y, window, expanding, na_method)
}
...
RollingMedian <- function(x, window, expanding = FALSE, na_method = "none") {
    .Call('RollingWindow_RollingMedian', PACKAGE = 'RollingWindow', x, window, expanding, na_method)
}
...
#'@details If input \code{x} contains more than one column, the rolling window calculation will be performed on each
#'column. The dimensions of the return value will be the same as input \code{x}.
RollingMin <- function(x, window, expanding = FALSE, na_method = "none") {
    .Call('RollingWindow_RollingMin', PACKAGE = 'RollingWindow', x, window, expanding, na_method)
}
...
RollingProd <- function(x, window, expanding = FALSE, na_method = "none") {
    .Call('RollingWindow_RollingProd', PACKAGE = 'RollingWindow', x, window, expanding, na_method)
}
...
#'where \eqn{x} and \eqn{y} represent the predicted and actual (true) values.
RollingRMSE <- function(x, y, window, expanding = FALSE, na_method = "none") {
    .Call('RollingWindow_RollingRMSE', PACKAGE = 'RollingWindow', x, y, window, expanding, na_method)
}
...
RollingSkew <- function(x, window, expanding = FALSE, na_method = "none", pop = FALSE) {
    .Call('RollingWindow_RollingSkew', PACKAGE = 'RollingWindow', x, window, expanding, na_method, pop)
}
...
RollingStd <- function(x, window, expanding = FALSE, na_method = "none", pop = FALSE) {
    .Call('RollingWindow_RollingStd', PACKAGE = 'RollingWindow', x, window, expanding, na_method, pop)
}
...
RollingSum <- function(x, window, expanding = FALSE, na_method = "none") {
    .Call('RollingWindow_RollingSum', PACKAGE = 'RollingWindow', x, window, expanding, na_method)
}
...
RollingSumprod <- function(x, y, window, expanding = FALSE, na_method = "none") {
    .Call('RollingWindow_RollingSumprod', PACKAGE = 'RollingWindow', x, y, window, expanding, na_method)
}
...
RollingSS <- function(x, window, expanding = FALSE, na_method = "none") {
    .Call('RollingWindow_RollingSS', PACKAGE = 'RollingWindow', x, window, expanding, na_method)
}
...
#'where \eqn{x} and \eqn{y} represent the predicted and actual (true) values.
RollingSSE <- function(x, y, window, expanding = FALSE, na_method = "none") {
    .Call('RollingWindow_RollingSSE', PACKAGE = 'RollingWindow', x, y, window, expanding, na_method)
}
...
RollingVar <- function(x, window, expanding = FALSE, na_method = "none", pop = FALSE) {
    .Call('RollingWindow_RollingVar', PACKAGE = 'RollingWindow', x, window, expanding, na_method, pop)
}
...
RollingZscore <- function(x, window, expanding = FALSE, na_method = "none", pop = FALSE) {
    .Call('RollingWindow_RollingZscore', PACKAGE = 'RollingWindow', x, window, expanding, na_method, pop)
}
...
#'where \eqn{\sigma} is the standard deviation of x.
RollingSharpe <- function(x, Rf, window, expanding = FALSE, na_method = "none", scale = 12) {
    .Call('RollingWindow_RollingSharpe', PACKAGE = 'RollingWindow', x, Rf, window, expanding, na_method, scale)
}
